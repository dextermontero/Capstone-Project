...
var dis1 = document.getElementById("exceed1");
var finishTime;
var timerLength = 60;
var timeoutID;
...
function Update() {
	...
	if(timeLeft > 0){
		...
		$('#client-password').attr('disabled', 'disabled');
		$('#index-login').attr('disabled', 'disabled');	
		...
		dis1.innerHTML = "Login limit exceed, Wait " + + Math.floor(timeLeft/1000,0) + " seconds to login.";
	}else {
		$('#exceed').attr('hidden', 'hidden');
