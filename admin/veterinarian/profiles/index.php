...
if(isset($_GET['profile'])){
	...
	$get = $_GET['profile'];
	$chkGet = "SELECT vet_id FROM vet_profile WHERE vet_id = '$get'";
	$resGet = $conn->query($chkGet);
	if($resGet -> num_rows > 0) {
		$prof_id = $_GET['profile'];
	}else {
...
<html lang="en">
	<head>
		<title>Veterinarian Profile | Vets at Work Veterinary Clinic</title>
							...
							<div class="row">
 								<div class="col-lg-4 col-12">
 									<div class="card">
                						<div class="card-body">
											<?php
												$sql = "SELECT photo, firstname, lastname, position FROM vet_profile WHERE vet_id = $get";
											...
											?>
												<div class="d-flex flex-column align-items-center text-center">
													...
													<div class="mt-3">
														...
														?>
															<p class="text-info mb-1"><?php echo $position; ?></p>
														<?php
															}
														?>
									...
									<div class="card ">
										...
										<div class="card-body">									
											<ul class="list-group list-group-flush">
												<?php
													$sql = "SELECT branch.name, branch.address FROM branch LEFT JOIN vet_profile on vet_profile.branch_id = branch.branch_id WHERE vet_profile.vet_id = $get";
													$result = $conn->query($sql);
													if($result -> num_rows > 0){
 								...
 								<div class="col-lg-8 col-12">
												...
												if($result -> num_rows > 0){
													...
													if($row['privilege'] == 1){
														...
														<div class="col-sm-4 text-right">
															<a class="btn btn-info btn-sm" href="'.web_root.'admin/account_management/veterinarian/profiles/edit.php?edit='.$_GET['profile'].'">
									...
									<div class="card-body">
										<?php
											$sql = "SELECT * FROM vet_profile WHERE vet_id = '$get'";
											$result = $conn->query($sql);
											if($result -> num_rows > 0){
												$row = $result -> fetch_assoc();
										?>
