...
<?php
$sql = "SELECT * FROM admin_profile WHERE admin_id = '$user'";
...
?>
	...
	<div class="row">
		...
		<div class="col-sm-9">
			<input type="text" class="form-control" id="contact_number" value="<?php echo $row['contact_number']; ?>" placeholder="Enter Phone Number">
		</div>
	</div>
	<hr>	
<?php
