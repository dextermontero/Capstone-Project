...
<html lang="en">
	...
	<body class="hold-transition sidebar-mini layout-fixed">
						...
						<div class="main-body">
							<div class="row">
 								<div class="col-lg-4 col-12">								
 									<div class="card">
										<?php
											$sql = "SELECT admin_id, photo, firstname, lastname, position FROM admin_profile WHERE admin_id = $user";
 									...
 									<div class="card-header">
										<div class="row mb-2">
											...
											<div class="col-sm-4 text-right">
												<?php
													if(!isset($_COOKIE['edit-profile-admin']) == 'edit-profile-admin'){
												?>
		...
		<script src="<?php echo web_root; ?>admin/profile/profile.js"></script>
	</body>
</html>
