							...
							<div class="row">
 								<div class="col-lg-4 col-12">
 									<div class="card">
                						<div class="card-body">
											<?php
												$sql = "SELECT photo, firstname, lastname, position FROM user_profile WHERE user_id = $adm_id";
											...
											?>
												<div class="d-flex flex-column align-items-center text-center">
													...
													<div class="mt-3">
														...
														?>
															<p class="text-success mb-1">Pet Owner</p>
														<?php
															}
														?>
										...
										<div class="card-body">
											<div class="direct-chat-messages">
												<table id="pet" class="table table-sm">
													...
													<tbody>
														<?php
															$sql = "SELECT * FROM pet_profile WHERE user_id = '$adm_id'";
															$result = $conn->query($sql);
															if($result -> num_rows > 0){
																while($row = $result -> fetch_assoc()){
														?>
														<tr>
															...
															<td class="py-1 px-2 text-center">
																<a class="btn btn-primary btn-sm" href="<?php echo web_root; ?>admin/informations/pets/profiles/profile.php?pet_id=<?php echo $row['pet_id'];?>">
 								...
 								<div class="col-lg-8 col-12">
									...
									<div class="card-body">
										<?php
											$sql = "SELECT * FROM user_profile WHERE user_id = '$adm_id'";
											$result = $conn->query($sql);
											if($result -> num_rows > 0){
