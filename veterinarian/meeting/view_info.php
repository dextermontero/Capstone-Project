...
if(isset($_POST['id'])){
	...
	if($result -> num_rows > 0){
		...
		<form action="" method="POST">
			<span id="service_id" hidden>'.$row['id'].'</span>
		...
		<form action="" method="POST">
			<div class="row">
				<div class="col-lg-12 col-12">
					<div class="form-group">
						<label for="topic_meeting">Topic Meeting</label>
						<input type="text" class="form-control" id="topic_meeting" placeholder="Enter Topic Meeting" value="" disabled>
					</div>
				</div>
				<div class="col-lg-6 col-6">
					<div class="form-group">
						<label for="date_meeting">Date Meeting</label>
						<input type="date" class="form-control" id="date_meeting" placeholder="Enter Topic Meeting" value="" disabled>
					</div>							
				</div>
				<div class="col-lg-6 col-6">
					<div class="form-group">
						<label for="start_meeting">Start Meeting</label>
						<input type="time" class="form-control" id="start_meeting" placeholder="Enter Topic Meeting" value="" disabled>
					</div>							
				</div>
			</div>
		</form>	';		
