							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="meeting" class="table table-borderedless table-striped table-hover table-sm">
										...
										<tbody>
											<?php 
												$sql = "SELECT zoom_meeting.meeting_id, zoom_meeting.topic, zoom_meeting.link, zoom_meeting.password, zoom_meeting.date, zoom_meeting.time, user_profile.firstname, user_profile.lastname FROM zoom_meeting INNER JOIN user_profile ON zoom_meeting.to_client = user_profile.user_id WHERE login_id = '$user'";
						...
						.done(function(data) {
							if(data == 'success'){
								Swal.fire({
									...
									icon : "success",
									html: "Successfully to create a meeting link",
									timer: 3000,
								...
								Swal.fire({
									title : "Create Meeting",
									icon : "warning",
									text: "Something wrong in creating meeting link.",
									timer: 3000,
									showConfirmButton:false							
								});
							}
							...
							.done(function(data) {
								if(data == "success"){
									Swal.fire({
										title : "Delete Meeting",
										icon : "success",
										html: "Successfully to delete meeting.",
										timer: 3000,
										showConfirmButton:false							
									}).then(function() {
										location.reload();
									...
									Swal.fire({
										title : "Delete Meeting",
										icon : "warning",
										text: "Something wrong in deleting meeting.",
										timer: 3000,
										showConfirmButton:false							
									});
								}
					...
					.done(function(data){
						if(data == "success"){
							Swal.fire({
								...
								icon : "success",
								html: "Successfully to update meeting.",
								timer: 3000,
								showConfirmButton:false							
							}).then(function() {
								location.reload();
							...
							Swal.fire({
								title : "Update Meeting",
								icon : "warning",
								text: "Something wrong in updating meeting.",
								timer: 3000,
								showConfirmButton:false							
							});
						}
