...
<html lang="en">
	<head>
		<title>Archived Reviews | Vets at Work Veterinary Clinic</title>
	...
	<body class="hold-transition sidebar-mini layout-fixed">
								...
								<div class="col-lg-4 col-12">
									<div class="d-flex flex-column flex-grow-1">
										<div class="small-box bg-info">
											<div class="inner">
												<?php
													$sql = "SELECT COUNT(*) as all_reviews FROM archive WHERE category = 'reviews' AND user_id = '$user'";
													$result = $conn->query($sql);
													if($result -> num_rows > 0){
														$row = $result -> fetch_assoc();
														$count_review = number_format($row['all_reviews']);
												?>
												<h3><?php echo $count_review; ?></h3>
												<?php
													}
												?>
		...
		<script src="<?php echo web_root; ?>veterinarian/archived/reviews/review.js"></script>		
	</body>
</html>
