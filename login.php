	...
	if($total_count == 5){
		...
		if($result -> num_rows > 0){
			...
			if($row['archive_status'] == '0'){
				if($row['roles'] == 'administrator' && $row['verification'] == 'active' || $row['roles'] == 'superadmin' && $row['verification'] == 'active'){
				...
				}elseif($row['roles'] == 'veterinarian' && $row['verification'] == 'active'){
					$_SESSION['login_id'] = $row['uid'];
					$_SESSION['roles'] = $row['roles'];
					$i = $row['uid'];
				...
				}elseif($row['roles'] == 'client' && $row['verification'] == 'active'){
					$_SESSION['login_id'] = $row['uid'];
					$_SESSION['roles'] = $row['roles'];
					$i = $row['uid'];
